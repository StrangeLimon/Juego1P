// Accede al botón y a la sección con la imagen por su ID
...
nuevoJuegoBtn.addEventListener("click", function() {
  // Muestra la sección con la imagen
  seccionImagen.style.display = "block";
  // Oculta el botón
  nuevoJuegoBtn.style.display = "none";
});
...
var game = (function () {
    ...
    function preloadImages () {
        ...
        bgMain = new Image();
        bgMain.src = '/images/divicion.jpg';
        bgBoss = new Image();
        bgBoss.src = '/images/entrada.png.jpg';
    ...
    function Evil (vidas, disparos) {
        ...
        this.pointsToKill = 20 + evilCounter;
    }
    ...
    function showCongratulations () {
        ...
        bufferctx.fillText("GUATAFAC AMIGO VOS ESTAS RELOCO!", canvas.width / 2 - 200, canvas.height / 2 - 30);
